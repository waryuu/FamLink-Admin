...
<div class="container">
    <div class="page-inner">
        <div class="page-header"><h4 class="page-title">{{$model['detail']->name}}</h4></div>
        @if ($errors->any())
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{$model['base_url']}}save-has-role" method="POST">
                                            ...
                                            <ul class="pagination pg-primary">
                                                <li class="page-item">
                                                    <label class="form-check-label">
                                                        ...
                                                        @endforeach
                                                        @if ($exist_head)
                                                        <input class="form-check-input" type="checkbox" name="menu[]" value="{{$item->id}}" checked>
                                                        @else
                                                        <input class="form-check-input" type="checkbox" name="menu[]" value="{{$item->id}}">
                                                        @endif
                                                    </label>
                                                </li>
                                            </ul>
                                ...
                                <li class="list-group-item align-items-center">
                                    ...
                                    <span class="ml-auto">
                                        <label class="form-check-label">
                                            ...
                                            @endforeach
                                            @if ($exist_head)
                                            <input class="form-check-input" type="checkbox" name="menu[]" value="{{$item_parent->id}}" checked>
                                            @else
                                            <input class="form-check-input" type="checkbox" name="menu[]" value="{{$item_parent->id}}">
                                            @endif
                            ...
                            <a href="{{$model['base_url']}}"><button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button></a>
                        </form>
                    </div>
                </div>
            </div>
