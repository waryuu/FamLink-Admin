                                            ...
                                            <div class="modal-body">
                                                <div class="card-body">
                                                    <div class="form-group form-show-validation row">
                                                        <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Name
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="username"
                                                            class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Username <span
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="email" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Email
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="password"
                                                            class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Password <span
                                                                class="required-label">*</span></label>
                                                        <div class="col-12">
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="confirmpassword"
                                                            class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Confirm Password
                                                            <span class="required-label">*</span></label>
                                                        <div class="col-12">
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Gender <span
                                                                class="required-label">*</span></label>
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="birth" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Birth
                                                            <span class="required-label">*</span></label>
                                                        <div class="col-12">
                                                            <div class="input-group">
                                                    ...
                                                    <div class="form-group form-show-validation row">
                                                        <label for="birth" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">State
                                                            <span class="required-label">*</span></label>
                                                        <div class="col-12">
                                                    ...
                                                    <div class="separator-solid"></div>
                                                    <div class="form-group form-show-validation row">
                                                        <label class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Upload Image <span
                                                                class="required-label">*</span></label>
                                                        <div class="col-12">
                                                            <div class="input-file input-file-image">
                                                                ...
                                                                <input type="file" class="form-control form-control-file"
                                                                    ...
                                                                    required>
                                                                <label for="uploadImg"
                                                                    class="btn btn-primary btn-round btn-lg"><i
                                                    ...
                                                    <div class="form-check">
                                                        <div class="row">
                                                            <label class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Agree <span
                                                                    class="required-label">*</span></label>
                                                            <div
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    <label class="custom-control-label" for="agree">Agree
            ...
            table = $(view_id).DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        name: 'id',
                        render: function(data, type, row) {
                            return '<div class="form-button-action"><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit"><i class="fa fa-edit"></i></button><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus" onclick="deleteAlert(' +
