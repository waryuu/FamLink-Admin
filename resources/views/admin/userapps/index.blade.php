                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <div class="form-group form-show-validation row">
                                                    <label for="title" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2">Nama User Apps <span class="required-label">*</span></label>
                                                    <div class="col-12">
...
<script>
    ...
    $(document).ready( function() {
        ...
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px; text-transform: uppercase;">'+row['nama_lengkap']+'</strong>';
        }},
        { data: 'jenis_kelamin', name: 'jenis_kelamin',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['jenis_kelamin']+'</strong>';
        }},
        { data: 'tanggal_lahir', name: 'tanggal_lahir',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+getAge(row['tanggal_lahir'])+'</strong>';
        }},
        { data: 'agama', name: 'agama',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['agama']+'</strong>';
        }},
        { data: 'pekerjaan', name: 'pekerjaan',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['pekerjaan']+'</strong>';
        }},
        { data: 'education', name: 'education',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['education']+'</strong>';
        }},
        { data: 'provinsi_ket', name: 'provinsi_ket',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['provinsi_ket']+'</strong>';
        }},
        { data: 'kabupaten_ket', name: 'kabupaten_ket',
        render : function(data, type, row) {
            return '<strong class=" col-red" style="font-size: 12px">'+row['kabupaten_ket']+'</strong>';
        }},
        ...
        { data: 'id', name: 'id', render : function(data, type, row) {
            return '<div class="form-button-action"><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus" onclick="deleteAlert('+row['id']+')"><i class="fa fa-times"></i></button></div>';
        }}];
        table = datatable(table_id, base_endpoint+'datatable/list', columnsData, [[ 0, "desc" ]]);
