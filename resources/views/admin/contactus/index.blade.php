...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <br />
            @if ($model['data'] == null)
                <div id="current_no_contactus" class="row">
                    <div class="col-12 col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="card-body m-4">
                                ...
                                <h6>Belum ada Informasi Kontak yang disimpan</h6>
                            </div>
                        </div>
                    </div>
                </div>

                <div id="create_contactus" class="row">
                    <div class="col-12 col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ $model['post_base_url']}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="card-body">
                                            <div>
                                                <h4><b>Buat Informasi Kontak</b></h4>
                                            </div>
                                            <div class="separator-solid"></div>
                                            <div class="form-group form-show-validation row">
                                                <label for="email">Email <span class="required-label">*</span></label>
                                                <input type="email" class="form-control" id="email" name="email"
                                                    placeholder="Masukan Email FamLink yang aktif" required>
                                            </div>
                                            <div class="form-group form-show-validation row">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" name="phone"
                                                        placeholder="Masukan Nomor WA Admin FamLink yang aktif" required>
                                                </div>
