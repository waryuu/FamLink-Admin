...
@section('title', 'Master Article')
@section('content')
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Master Article</h4>
        </div>
        @if ($errors->any())
...
<script>
    ...
    $(document).ready( function() {
        ...
        { data: 'icon', name: 'icon', render : function(data, type, row) {
            return '<img src="/public/article/'+row['image']+'" width="100px"/>';
        }},
        ...
        render : function(data, type, row) {
            if (row['type'] == 1) {
                return '<button class="btn btn-success">Text</button>';
            }else{
